var masteryStudies = {
	...
	timeStudyDescs: {
		...
		312: "元維度提升強 4.5%，而且價格增加減少 1 個。",
		321: "如果每十個反物質維度的加成為 1x，將它加強至 <span id='321effect'></span>x。",
		322: "時間速度極度輕微影響膨脹時間的生產力。",
		323: "取消複製器對反物質維度的加強的膨脹懲罰。",
		331: "維度超音速的價格增幅延後 240,000 個，而且價格增加減少 3 個。",
		332: "基於你的反物質星系，複製器的複製速度更快。",
		341: "前子稍微影響膨脹時間的生產力。",
		342: "所有複製器星系更強，並使用同一個公式。",
