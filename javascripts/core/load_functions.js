...
function setChallengeDisplay(){
        ...
        document.getElementById("infPowEffectPowerDiv").innerHTML=player.galacticSacrifice&&player.pSac==undefined?"加上 <span id='infPowEffectPower' style='font-size:35px; color: black'></span> 的次方之後，":""
